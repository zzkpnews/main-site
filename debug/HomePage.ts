...
export const HomePageDebugData: HomePageServerProps = {
  booksShowBoxData: Array(5).fill({
    img_url: 'https://www.zzkpnews.com/d/file/p/2022/04-11/02d4aeb6554fc5c349d543d4f95b599f.jpg',
  ...
  hotListBoxData: [
    { title: '韩媒：韩国首尔踩踏事故已致153人遇难', href: 'https://www.baidu.com' },
    { title: '河北检察机关依法对于鲁明涉嫌受贿案提起公诉', href: 'https://www.baidu.com' },
    { title: '见证中国发展变化 搭建交流沟通桥梁', href: 'https://www.baidu.com' },
    {
      title: '山东临沂：邮递员七年帮20多位烈士“回家”',
      subtitle: '今朝英雄归故里，王德建怀着对革命先烈们的敬意默默温暖人世间。',
      href: 'https://www.baidu.com',
    },
    { title: '前三季度农业农村经济稳中向好 稳中有进 何以实现？', href: 'https://www.baidu.com' },
